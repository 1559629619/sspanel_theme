							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										<br><p class="card-heading card-heading-orange"><i class="icon icon-md">phonelink</i> 快速添加节点</p>
											...
											<div class="tab-content">
												<div class="tab-pane fade {if $ssr_prefer}active in{/if}" id="all_ssr">
													...
													<div class="tab-pane fade active in" id="all_ssr_windows">
                                                       ...
                                                       <p><span class="icon icon-lg text-white">filter_5</span> 更新后选择其中一个节点闪电图标测试节点-测试UDP转发...通过!（UDP通过即可连接并开始游戏），如测试不通过，点击齿轮图标设置DNS，推荐谷歌DNS</p>
														<div class="mytags has-addons"><span class="icon icon-lg text-white">flash_auto</span> <span>订阅地址： </span><span class="tage is-prelast is-warning is-sub mrb-no">{$baseUrl}/link/{$ssr_sub_token}?mu=0</div><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$baseUrl}/link/{$ssr_sub_token}?mu=0">点击拷贝订阅地址</button><br>
                                                  ...
                                                  <div class="tab-pane fade" id="all_ssr_linux">
													...
													<div class="tab-pane fade" id="all_ssr_android">
														...
														<p><span class="icon icon-lg text-white">filter_1</span>（注意如果您是安卓8.0强烈建议您下载ssrr，ssr会断流不稳定）点击下载<a href="/ssr-download/ssr-android.apk"> SSR </a> 或 <a href="/ssr-download/ssrr-android.apk"> SSRR </a> 并安装</p>
                                                      ...
                                                      <p><span class="icon icon-lg text-white">filter_7</span> 点击选择任意节点， 路由选择：略过区域网路以及中国大陆</p>
														...
														<p><span class="icon icon-lg text-white">filter_9</span> 备用导入节点方法：在手机上默认浏览器中点击<a href="{$ssr_url_all}">这个链接（普通端口）</a>，然后点击确定</p>
														<div class="mytags has-addons"><span class="icon icon-lg text-white">flash_auto</span> <span>订阅地址： </span><span class="tage is-prelast is-warning is-sub mrb-no">{$baseUrl}/link/{$ssr_sub_token}?mu=0</div><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$baseUrl}/link/{$ssr_sub_token}?mu=0">点击拷贝订阅地址</button><br>
												...
												<div class="tab-pane fade" id="all_ssd">
													...
													<div class="tab-pane fade active in" id="all_ssd_windows">
														...
														<p><span class="icon icon-lg text-white">filter_4</span> 备用导入节点方法：点击<a class="copy-text" data-clipboard-text='{$ssd_url_all}'>这里</a>，然后右键小飞机->从剪贴板复制</p>
														<p><span class="icon icon-lg text-white">flash_auto</span> 节点订阅地址：<input type="text" class="tage is-prelast is-warning is-sub mrb-no" name="input1" readonly value="{$baseUrl}/link/{$ssr_sub_token}?mu=3" readonly="true"><button class="copy-text btn btn-subscription" type="button" data-clipboard-text="{$baseUrl}/link/{$ssr_sub_token}?mu=3">点击拷贝订阅地址</button><br></p>
													...
													<div class="tab-pane fade" id="all_ssd_ios">
														<p>推荐下载<a href="https://itunes.apple.com/cn/app/shadowrocket/id932747118?mt=8">Shadowrocket</a>，请在左侧菜单栏里提交工单申请已购买软件的美国商店Apple ID自行切换商店账号下载安装，为了您的隐私安全，请不要登录 iCloud 。下载完成后在 Safari 中点击<a href="{$ss_url_all}">这个（普通端口）</a>或者<a href="{$ss_url_all_mu}">这个（单端口多用户）</a>，然后点击确定，就可以批量添加节点。</p>
														<p>iOS 下载<a href="/link/{$ios_token}?is_ss=1">这个（普通端口）</a>，导入到 Surge 中，然后就可以随意切换服务器上网了。</p>
													</div>
												...
												<div class="tab-pane fade" id="all_v2ray">
													...
													<div class="tab-pane fade active in" id="all_v2ray_info">
														...
														<p>
	<strong><span style="color:#9933E5;">V2RAY服务只提供给年付及以上套餐的用户</span></strong>

	联系QQ727430820 索要配置文件及客户端&nbsp; 也可提供远程支持&nbsp; &nbsp;
</p>
										...
										<!--
											<div class="card-action-btn pull-left">
												<p><a class="reset-link btn btn-brand btn-flat waves-attach" >&nbsp;重置订阅链接（重置后之前的订阅链接会失效）</a></p>
											</div>
										-->
									</div>
							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no"><br>
                                    <p class="card-heading card-heading-red"><i class="icon icon-md">notifications_active</i> 公告栏</p>
                               
	<p style="color:#212121;font-family:&quot;font-size:15px;background-color:#FFFFFF;">
		①新用户注册可获得1天1024MB的 至尊VIP会员 等级体验，体验结束您的账户将过期不能使用任何节点。<br />
                                      ②<a href="https://loverui.xyz/FAQ.docx" target="_blank"><strong>点此下载帮助文档</strong></a><br />
注：最好加群，群里有热情的基友为你解(P)答(Y)!。
               <HR style="border:1 dashed #987cb9" width="80%" color=#987cb9 SIZE=1>
								...
								{if $ann != null}
										...
										<br><p class="card-heading">站长联系方式</p>
						...
						<div class="col-lg-6 col-md-6">
							...
							<div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										<br> <p class="card-heading card-heading-news"><i class="icon icon-md">fiber_new</i> 账号信息</p>
										<dl class="dl-horizontal">
											<p><dt>帐号等级</dt>
                                           
											<dd><i class="icon icon-md t4-text">stars</i>&nbsp; 等级：{if $user->class==1} <span style="color:#E53333;font-size:18px;"><strong>VIP</strong></span> {elseif $user->class==2} <span style="color:#9933E5;font-size:18px;"><strong>至尊VIP</strong></span>  {elseif $user->class==0} 试用 {/if}</dd>
...
<!---
								...
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
                                       <p class="card-heading card-heading-blue"><i class="icon icon-md">bookmark_border</i> 流量信息</p>
                                      	<div class="card-content">

                                                <ul class="unstyled">
                                                <li> <span class="icon24 icomoon-icon-arrow-up-2 green"></span> 今日使用量 <span class="pull-right strong"> {number_format(($user->u+$user->d-$user->last_day_t)/$user->transfer_enable*100,2)}% {$user->TodayusedTraffic()}</span>
                                                    <div class="speed-progress progress-success progress-striped ">
                                                    <div class="bar" style="width: {number_format(($user->u+$user->d-$user->last_day_t)/$user->transfer_enable*100,2)}%;"></div>
                                                    </div>
                                                </li>

                                                <li> <span class="icon24 icomoon-icon-arrow-down-2 red"></span>过去已用 <span class="pull-right strong">{number_format($user->last_day_t/$user->transfer_enable*100,2)}% {$user->LastusedTraffic()}</span>
                                                    <div class="speed-progress progress-warning progress-striped ">
                                                    <div style="width: {number_format($user->last_day_t/$user->transfer_enable*100,2)}%;" class="bar"></div>
                                                    </div>
                                                </li>

                                                <li> <span class="icon24 green"></span> 剩余流量  <span class="pull-right strong">{number_format(($user->transfer_enable-($user->u+$user->d))/$user->transfer_enable*100,2)}% {$user->unusedTraffic()}</span>
                                                    <div class="speed-progress progress-striped ">
                                                     <div style="width: {number_format(($user->transfer_enable-($user->u+$user->d))/$user->transfer_enable*100,2)}% ;" class="bar"></div>
                                                    </div>
                                                </li>
                              ...
                              <div class="card">
								<div class="card-main">
									<div class="card-inner margin-bottom-no">
										...
										<div id="traffic_chart" style="height: 360px; width: 100%;"></div>
...
<div class="card">
							<div class="card-main">
								<div class="card-inner margin-bottom-no">
									<br><p class="card-heading card-heading-news"><i class="icon icon-md">fiber_new</i> 最近五分钟使用ip</p>
							...
							<div class="card-main">
								<div class="card-inner margin-bottom-no">
									<br><p class="card-heading card-heading-news"><i class="icon icon-md">fiber_new</i> 最近十次登录ip</p>
