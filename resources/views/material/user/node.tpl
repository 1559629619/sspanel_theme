							...
							<div class="card">
								...
								<div class="card-main">
									...
									<div class="card-inner margin-bottom-no">
										<div class="tile-wrap">
								<div class="card-heading card-heading-free">免费线路</div>
											{$id=0}
...
<br><br>
								<div class="card-heading card-heading-vip1">VIP线路</div>
...
{if $node->sort == 11} 
											...
											{/foreach}<br><br>
 <div class="card-heading card-heading-vip2">至尊VIP线路</div>
